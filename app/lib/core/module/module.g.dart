...
final registry = ModuleRegistry({
  'TheButtonModule': ModuleInstance<TheButtonModule>(TheButtonModule(),
      {'getButtonCard': ModuleFactory<TheButtonModule, ContentSegment>((c, m, id) => m.getButtonCard())}),
  ...
  'WelcomeModule': ModuleInstance<WelcomeModule>(WelcomeModule(), {
    'getAction1': ModuleFactory<WelcomeModule, QuickAction>((c, m, id) => m.getAction1()),
    'getWelcomeBanner': ModuleFactory<WelcomeModule, ContentSegment>((c, m, id) => m.getWelcomeBanner(id))
  }),
