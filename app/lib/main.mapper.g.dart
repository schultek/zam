...
class TripMapper extends BaseMapper<Trip> {
  ...
  Trip fromMap(Map<String, dynamic> map) => Trip(id: map.get('id'), name: map.get('name'), template: map.get('template'), users: map.getMapOpt('users') ?? const {}, modules: map.getMapOpt('modules') ?? const {});

  @override Function get encoder => (Trip v) => encode(v);
  dynamic encode(Trip v) => toMap(v);
  Map<String, dynamic> toMap(Trip t) => {'id': Mapper.toValue(t.id), 'name': Mapper.toValue(t.name), 'template': Mapper.toValue(t.template), 'users': Mapper.toValue(t.users), 'modules': Mapper.toValue(t.modules)};

  @override String? stringify(Trip self) => 'Trip(name: ${self.name}, id: ${self.id}, template: ${self.template}, users: ${self.users}, modules: ${self.modules})';
  @override int? hash(Trip self) => self.id.hashCode ^ self.name.hashCode ^ self.template.hashCode ^ self.users.hashCode ^ self.modules.hashCode;
  @override bool? equals(Trip self, Trip other) => self.id == other.id && self.name == other.name && self.template == other.template && self.users == other.users && self.modules == other.modules;
...
extension TripMapperExtension on Trip {
  ...
  Trip copyWith({String? id, String? name, TemplateModel? template, Map<String, TripUser>? users, Map<String, List<String>>? modules}) => Trip(id: id ?? this.id, name: name ?? this.name, template: template ?? this.template, users: users ?? this.users, modules: modules ?? this.modules);
}
...
class TripUserMapper extends BaseMapper<TripUser> {
  ...
  TripUser fromMap(Map<String, dynamic> map) => TripUser(role: map.get('role'), nickname: map.getOpt('nickname'), profileUrl: map.getOpt('profileUrl'));
  ...
  @override String? stringify(TripUser self) => 'TripUser(role: ${self.role}, nickname: ${self.nickname}, profileUrl: ${self.profileUrl})';
  @override int? hash(TripUser self) => self.role.hashCode ^ self.nickname.hashCode ^ self.profileUrl.hashCode;
  @override bool? equals(TripUser self, TripUser other) => self.role == other.role && self.nickname == other.nickname && self.profileUrl == other.profileUrl;
...
extension TripUserMapperExtension on TripUser {
  String toJson() => Mapper.toJson(this);
  Map<String, dynamic> toMap() => Mapper.toMap(this);
  TripUser copyWith({String? role, String? nickname, String? profileUrl}) => TripUser(role: role ?? this.role, nickname: nickname ?? this.nickname, profileUrl: profileUrl ?? this.profileUrl);
}
...
class NoteMapper extends BaseMapper<Note> {
  ...
  @override String? stringify(Note self) => 'Note(id: ${self.id}, title: ${self.title}, content: ${self.content}, folder: ${self.folder}, isArchived: ${self.isArchived}, author: ${self.author}, editors: ${self.editors})';
  @override int? hash(Note self) => self.id.hashCode ^ self.title.hashCode ^ self.content.hashCode ^ self.folder.hashCode ^ self.isArchived.hashCode ^ self.author.hashCode ^ self.editors.hashCode;
  @override bool? equals(Note self, Note other) => self.id == other.id && self.title == other.title && self.content == other.content && self.folder == other.folder && self.isArchived == other.isArchived && self.author == other.author && self.editors == other.editors;
...
extension NoteMapperExtension on Note {
  String toJson() => Mapper.toJson(this);
  Map<String, dynamic> toMap() => Mapper.toMap(this);
  Note copyWith({String? id, String? title, List<dynamic>? content, String? folder, bool? isArchived, String? author, List<String>? editors}) => Note(id ?? this.id, title ?? this.title, content ?? this.content, folder: folder ?? this.folder, isArchived: isArchived ?? this.isArchived, author: author ?? this.author, editors: editors ?? this.editors);
}
...
class TemplateModelMapper extends BaseMapper<TemplateModel> {
  ...
  dynamic encode(TemplateModel v) {
    if (v is GridTemplateModel) { return GridTemplateModelMapper._().encode(v); }
  ...
  @override String? stringify(TemplateModel self) => 'TemplateModel(type: ${self.type})';
  @override int? hash(TemplateModel self) => self.type.hashCode;
  @override bool? equals(TemplateModel self, TemplateModel other) => self.type == other.type;
...
class GridTemplateModelMapper extends BaseMapper<GridTemplateModel> {
  ...
  @override String? stringify(GridTemplateModel self) => 'GridTemplateModel(type: ${self.type})';
  @override int? hash(GridTemplateModel self) => self.type.hashCode;
  @override bool? equals(GridTemplateModel self, GridTemplateModel other) => self.type == other.type;
...
class SwipeTemplateModelMapper extends BaseMapper<SwipeTemplateModel> {
  ...
  @override String? stringify(SwipeTemplateModel self) => 'SwipeTemplateModel(type: ${self.type})';
  @override int? hash(SwipeTemplateModel self) => self.type.hashCode;
  @override bool? equals(SwipeTemplateModel self, SwipeTemplateModel other) => self.type == other.type;
...
class ChannelInfoMapper extends BaseMapper<ChannelInfo> {
  ...
  @override String? stringify(ChannelInfo self) => 'ChannelInfo(name: ${self.name}, id: ${self.id}, isOpen: ${self.isOpen}, members: ${self.members})';
  @override int? hash(ChannelInfo self) => self.id.hashCode ^ self.name.hashCode ^ self.isOpen.hashCode ^ self.members.hashCode;
  @override bool? equals(ChannelInfo self, ChannelInfo other) => self.id == other.id && self.name == other.name && self.isOpen == other.isOpen && self.members == other.members;
...
extension ChannelInfoMapperExtension on ChannelInfo {
  String toJson() => Mapper.toJson(this);
  Map<String, dynamic> toMap() => Mapper.toMap(this);
  ChannelInfo copyWith({String? id, String? name, bool? isOpen, List<String>? members}) => ChannelInfo(id: id ?? this.id, name: name ?? this.name, isOpen: isOpen ?? this.isOpen, members: members ?? this.members);
}
...
class ChatMessageMapper extends BaseMapper<ChatMessage> {
  ...
  @override String? stringify(ChatMessage self) => 'ChatMessage(sender: ${self.sender}, text: ${self.text}, sentAt: ${self.sentAt})';
  @override int? hash(ChatMessage self) => self.sender.hashCode ^ self.text.hashCode ^ self.sentAt.hashCode;
  @override bool? equals(ChatMessage self, ChatMessage other) => self.sender == other.sender && self.text == other.text && self.sentAt == other.sentAt;
...
extension ChatMessageMapperExtension on ChatMessage {
  String toJson() => Mapper.toJson(this);
  Map<String, dynamic> toMap() => Mapper.toMap(this);
  ChatMessage copyWith({String? sender, String? text, DateTime? sentAt}) => ChatMessage(sender: sender ?? this.sender, text: text ?? this.text, sentAt: sentAt ?? this.sentAt);
}
